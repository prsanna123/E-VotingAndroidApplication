...
import 'package:samp/features/user_auth/firebase_auth_implementation/firebase_auth_services.dart';
import 'package:samp/features/user_auth/presentation/pages/login_page.dart';
import 'package:samp/features/user_auth/presentation/widgets/form_container_widget.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _signUp() async {
    ...
    if (user!= null){
      ...
      Navigator.pushNamed(context, "/upload",arguments:{'email':email});
    } else{
